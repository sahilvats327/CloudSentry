        ...
        try {
            ...
            for (var securityGroup : response.securityGroups()) {
                ...
                for (IpPermission permission :
                    ...
                    /*
                     * A protocol of -1 means all protocols
                     * and therefore all ports.
                     *
                     * Some AWS rules may also have no explicit
                     * port range.
                     */
                    boolean allPorts =
                            "-1".equals(protocol)
                    ...
                    /*
                     * CloudSentry monitors important/common
                     * service ports instead of iterating through
                     * every possible port in a large range.
                     *
                     * This prevents a rule such as 0-65535
                     * from producing 65,536 iterations.
                     */
                    int[] monitoredPorts = {
                            22,      // SSH
                            3389,    // RDP
                    ...
                    for (IpRange ipRange : permission.ipRanges()) {
                        ...
                        /*
                         * IPv4 public access is handled here.
                         * IPv6 public access is handled separately
                         * by CS-EC2-010.
                         */
            ...
            /*
             * If no public monitored ports were detected,
             * report a PASS finding.
             */
            if (findings.isEmpty()) {

                System.out.println(
                        "Public Security Group Access: NONE [PASS]"
                );
                ...
                findings.add(
                        new SecurityFinding(
                                ...
                                "PASS",
                                "NONE",
                                "No monitored service ports were found publicly accessible from 0.0.0.0/0.",
                                "No action required. Continue restricting security group ingress to trusted networks."
                        )
                );
            }
